...
interface MainRepository {
    ...
    suspend fun sendProfileData(successCallback: (response: NetworkResult<String>) -> Unit, surname: String, countryId: String, skillLevel: String, autoPosition: String, autoPlay: String, worldCupId: String, filepath: String)
    ...
    suspend fun saveScoreList(successCallback: (response: NetworkResult<String>) -> Unit, total_goal: String, total_goal_console: String, match_status: String,captianId:String,total_defence: String, opponent_guessed: String, my_guesses: String ,matchNumber: String)
